...
## Create a tokenizer for vocab bert was trained on
...
# TPUEstimator handles many of the details of running on TPU 
...
if FLAGS.do_predict:
  ...
  ### Read in competition file (json format)
